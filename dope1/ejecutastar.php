...
//generamos la sentencia para la modificación filtrando por el id para que solo cambie ese registro
	case 'modifica':$sql="UPDATE star SET 
	                      namestar='".$_POST['namestar'][$indice]."',
						  genero='".$_POST['genero'][$indice]."',
						    fotos'".$_POST['fotos'][$indice]."'
						  WHERE idstar=".$_POST['idstar'][$indice];break;
	case 'elimina':$sql="DELETE FROM star WHERE idstar=".$_POST['idstar'][$indice];break;
