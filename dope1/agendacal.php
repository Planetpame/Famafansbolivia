...
<head>
	...
	<title>Calendario de Conciertos Fama Fans</title>
	...
	function formatDate (input) {
		...
		$(document).ready(function()
		{
			...
			$(document).on("click",'.eliminar_evento',function (e) 
			{
				...
				$(location).attr('href',"datos_evento.php?idcal="+id);
			});
